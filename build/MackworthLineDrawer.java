...
public class MackworthLineDrawer extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("MackworthLineDrawer");
        metaclass.setRubyStaticAllocator(MackworthLineDrawer.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: MackworthLineDrawer");
     ...
     */
    private MackworthLineDrawer(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new MackworthLineDrawer(ruby, metaClass);
    }

    
    public  MackworthLineDrawer() {
