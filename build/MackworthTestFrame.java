...
public class MackworthTestFrame extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("MackworthTestFrame");
        metaclass.setRubyStaticAllocator(MackworthTestFrame.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: MackworthTestFrame");
     ...
     */
    private MackworthTestFrame(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new MackworthTestFrame(ruby, metaClass);
    }

    
    public  MackworthTestFrame() {
    ...
    public Object run_intro() {

        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "run_intro");
        return (Object)ruby_result.toJava(Object.class);

    }

    
    public Object run_demo() {

        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "run_demo");
        return (Object)ruby_result.toJava(Object.class);

    }

    
    public Object get_about_text() {

        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "get_about_text");
        return (Object)ruby_result.toJava(Object.class);
