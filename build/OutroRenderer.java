...
public class OutroRenderer extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("OutroRenderer");
        metaclass.setRubyStaticAllocator(OutroRenderer.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: OutroRenderer");
     ...
     */
    private OutroRenderer(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new OutroRenderer(ruby, metaClass);
    }

    
    public  OutroRenderer(Object test) {
