...
public class MackworthTestRunner extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("MackworthTestRunner");
        metaclass.setRubyStaticAllocator(MackworthTestRunner.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: MackworthTestRunner");
     ...
     */
    private MackworthTestRunner(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new MackworthTestRunner(ruby, metaClass);
    }

    
    public  MackworthTestRunner(Object mainpanel, Object iterations) {
        this(__ruby__, __metaclass__);
        IRubyObject ruby_mainpanel = JavaUtil.convertJavaToRuby(__ruby__, mainpanel);
        IRubyObject ruby_iterations = JavaUtil.convertJavaToRuby(__ruby__, iterations);
        RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "initialize", ruby_mainpanel, ruby_iterations);

    }

    
    public Object update_line_length(Object is_long_len) {
        IRubyObject ruby_is_long_len = JavaUtil.convertJavaToRuby(__ruby__, is_long_len);
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "update_line_length", ruby_is_long_len);
    ...
    public Object repaint() {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "repaint");
        return (Object)ruby_result.toJava(Object.class);

    }

    
    public Object run_iteration(Object num) {
        IRubyObject ruby_num = JavaUtil.convertJavaToRuby(__ruby__, num);
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "run_iteration", ruby_num);
        return (Object)ruby_result.toJava(Object.class);
    ...
    public Object run_test() {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "run_test");
        return (Object)ruby_result.toJava(Object.class);

    }

    
    public Object show_outro() {

        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "show_outro");
        return (Object)ruby_result.toJava(Object.class);
    ...
    public Object run() {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "run");
        return (Object)ruby_result.toJava(Object.class);
