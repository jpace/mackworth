...
public class IntroRenderer extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("IntroRenderer");
        metaclass.setRubyStaticAllocator(IntroRenderer.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: IntroRenderer");
     ...
     */
    private IntroRenderer(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new IntroRenderer(ruby, metaClass);
    }

    
    public  IntroRenderer(Object test) {
