...
public class MackworthTestDemo extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("MackworthTestDemo");
        metaclass.setRubyStaticAllocator(MackworthTestDemo.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: MackworthTestDemo");
     ...
     */
    private MackworthTestDemo(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new MackworthTestDemo(ruby, metaClass);
    }

    
    public  MackworthTestDemo(Object mainpanel) {
