...
public class MackworthTestParameters extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("MackworthTestParameters");
        metaclass.setRubyStaticAllocator(MackworthTestParameters.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: MackworthTestParameters");
     ...
     */
    private MackworthTestParameters(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new MackworthTestParameters(ruby, metaClass);
    }
     ...
     * @param metaclass The RubyClass representing the Ruby class of this object
     */
    public MackworthTestParameters() {
