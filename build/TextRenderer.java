...
public class TextRenderer extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("TextRenderer");
        metaclass.setRubyStaticAllocator(TextRenderer.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: TextRenderer");
     ...
     */
    private TextRenderer(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new TextRenderer(ruby, metaClass);
    }
