...
public class MackworthTest extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("MackworthTest");
        metaclass.setRubyStaticAllocator(MackworthTest.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: MackworthTest");
     ...
     */
    private MackworthTest(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new MackworthTest(ruby, metaClass);
    }

    
    public  MackworthTest(Object mainpanel) {
        this(__ruby__, __metaclass__);
        IRubyObject ruby_mainpanel = JavaUtil.convertJavaToRuby(__ruby__, mainpanel);
        RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "initialize", ruby_mainpanel);

    }

    
    public Object write_responses() {

        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "write_responses");
