...
public class MackworthTestIntro extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("MackworthTestIntro");
        metaclass.setRubyStaticAllocator(MackworthTestIntro.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: MackworthTestIntro");
     ...
     */
    private MackworthTestIntro(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new MackworthTestIntro(ruby, metaClass);
    }

    
    public  MackworthTestIntro(Object mainpanel) {
