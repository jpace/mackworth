...
public class MackworthTestResultsFile extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("MackworthTestResultsFile");
        metaclass.setRubyStaticAllocator(MackworthTestResultsFile.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: MackworthTestResultsFile");
     ...
     */
    private MackworthTestResultsFile(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new MackworthTestResultsFile(ruby, metaClass);
    }

    
    public static Object home_directory() {

        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), __metaclass__, "home_directory");
        return (Object)ruby_result.toJava(Object.class);

    }

    
    public  MackworthTestResultsFile() {
    ...
    public Object addlines(Object lines) {
        IRubyObject ruby_lines = JavaUtil.convertJavaToRuby(__ruby__, lines);
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "addlines", ruby_lines);
        return (Object)ruby_result.toJava(Object.class);
    ...
    public Object write() {
        ...
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "write");
        return (Object)ruby_result.toJava(Object.class);
