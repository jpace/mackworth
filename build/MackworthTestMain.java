...
public class MackworthTestMain extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("MackworthTestMain");
        metaclass.setRubyStaticAllocator(MackworthTestMain.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: MackworthTestMain");
     ...
     */
    private MackworthTestMain(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new MackworthTestMain(ruby, metaClass);
    }
