...
public class MainPanel extends RubyObject  {
    ...
    static {
        ...
        RubyClass metaclass = __ruby__.getClass("MainPanel");
        metaclass.setRubyStaticAllocator(MainPanel.class);
        if (metaclass == null) throw new NoClassDefFoundError("Could not load Ruby class: MainPanel");
     ...
     */
    private MainPanel(Ruby ruby, RubyClass metaclass) {
    ...
    public static IRubyObject __allocate__(Ruby ruby, RubyClass metaClass) {
        return new MainPanel(ruby, metaClass);
    }
    ...
    public Object paintComponent(Object g) {
        IRubyObject ruby_g = JavaUtil.convertJavaToRuby(__ruby__, g);
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "paintComponent", ruby_g);
        return (Object)ruby_result.toJava(Object.class);

    }

    
    public Object clear_screen(Object g, Object dim) {
        IRubyObject ruby_g = JavaUtil.convertJavaToRuby(__ruby__, g);
        IRubyObject ruby_dim = JavaUtil.convertJavaToRuby(__ruby__, dim);
        IRubyObject ruby_result = RuntimeHelpers.invoke(__ruby__.getCurrentContext(), this, "clear_screen", ruby_g, ruby_dim);
        return (Object)ruby_result.toJava(Object.class);
